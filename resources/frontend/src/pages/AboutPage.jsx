...
const AboutPage = () => {
  ...
  const achievements = [
    ...
    { number: "100+", label: "Happy Families", icon: "🏡" },
  ...
  const team = [
    {
      ...
      description: "Leading the vision with expertise in structural engineering and sustainable construction practices."
    },
    {
      name: "Priya Sharma",
      role: "Chief Architect",
      experience: "12+ years",
      specialization: "Residential Architecture & Design",
      image: "https://images.unsplash.com/photo-1594736797933-d0c6268fb74c?w=300",
      description: "Transforming dreams into blueprints with innovative design solutions and space optimization."
    },
    {
      name: "Amit Kumar",
      ...
      description: "Ensuring every project meets our high standards through meticulous planning and execution."
    }
  ];

  const milestones = [
    { year: "2019", event: "Company Founded", description: "Started with a vision to build quality homes in Pune" },
    { year: "2020", event: "First Major Project", description: "Completed 20-unit apartment complex in Baner" },
    { year: "2021", event: "Expansion", description: "Expanded team and services across Pune metropolitan area" },
    { year: "2022", event: "50 Projects Milestone", description: "Successfully delivered 50+ residential projects" },
    { year: "2023", event: "Awards & Recognition", description: "Received 'Best Construction Company' award from Pune Chamber" },
    { year: "2024", event: "Digital Transformation", description: "Launched online platform for better customer experience" }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <section id="achievements" className="py-20 animate-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className={`grid grid-cols-2 lg:grid-cols-3 gap-8 transition-all duration-1000 ${
